	...
	if (isObject(arg) && unsafeLocal in arg && "add" in arg && "field" in arg && typeof arg.field == "function") {
		if (field !== undefined) {
			...
			return (
				...
				a.scalar === b.scalar &&
				((_a = a.message) === null || _a === undefined ? undefined : _a.typeName) === ((_b = b.message) === null || _b === undefined ? undefined : _b.typeName) &&
				((_c = a.enum) === null || _c === undefined ? undefined : _c.typeName) === ((_d = b.enum) === null || _d === undefined ? undefined : _d.typeName)
			);
		}
		return true;
	}
...
function isWrapperTypeName(name) {
	return (
		...
		["DoubleValue", "FloatValue", "Int64Value", "UInt64Value", "Int32Value", "UInt32Value", "BoolValue", "StringValue", "BytesValue"].includes(name.substring(16))
	);
}
...
function bootFileDescriptorProto(init) {
	...
	return Object.assign(
		proto,
		Object.assign(
			Object.assign({ $typeName: "google.protobuf.FileDescriptorProto", dependency: [], publicDependency: [], weakDependency: [], optionDependency: [], service: [], extension: [] }, init),
...
function bootDescriptorProto(init) {
	...
	return Object.assign(proto, {
		...
		extensionRange:
			(_h = (_g = init.extensionRange) === null || _g === undefined ? undefined : _g.map((e) => Object.assign({ $typeName: "google.protobuf.DescriptorProto.ExtensionRange" }, e))) !== null &&
			_h !== undefined
				? _h
				: [],
		oneofDecl: [],
...
function bootFieldOptions(init) {
	...
	return Object.assign(
		...
		Object.assign(Object.assign({ $typeName: "google.protobuf.FieldOptions" }, init), {
			...
			editionDefaults:
				(_c = (_b = init.editionDefaults) === null || _b === undefined ? undefined : _b.map((e) => Object.assign({ $typeName: "google.protobuf.FieldOptions.EditionDefault" }, e))) !== null &&
				_c !== undefined
					? _c
					: [],
			uninterpretedOption: [],
	...
	messageType: [
		...
		},
		{
			...
			field: [
				...
				{ name: "visibility", number: 11, type: 14, label: 1, typeName: ".google.protobuf.SymbolVisibility" },
			],
			nestedType: [
				{
					name: "ExtensionRange",
		...
		},
		{
			...
			field: [
				...
				{ name: "declaration", number: 2, type: 11, label: 3, typeName: ".google.protobuf.ExtensionRangeOptions.Declaration", options: { retention: 2 } },
				{ name: "features", number: 50, type: 11, label: 1, typeName: ".google.protobuf.FeatureSet" },
				{ name: "verification", number: 3, type: 14, label: 1, typeName: ".google.protobuf.ExtensionRangeOptions.VerificationState", defaultValue: "UNVERIFIED", options: { retention: 2 } },
			],
			nestedType: [
				{
					name: "Declaration",
		...
		},
		{
			...
			field: [
				...
				{ name: "reserved_range", number: 4, type: 11, label: 3, typeName: ".google.protobuf.EnumDescriptorProto.EnumReservedRange" },
				{ name: "reserved_name", number: 5, type: 9, label: 3 },
				{ name: "visibility", number: 6, type: 14, label: 1, typeName: ".google.protobuf.SymbolVisibility" },
			],
			nestedType: [
				{
		...
		},
		{
			...
			field: [
				...
				{ name: "optimize_for", number: 9, type: 14, label: 1, typeName: ".google.protobuf.FileOptions.OptimizeMode", defaultValue: "SPEED" },
		...
		},
		{
			name: "FieldOptions",
			field: [
				{ name: "ctype", number: 1, type: 14, label: 1, typeName: ".google.protobuf.FieldOptions.CType", defaultValue: "STRING" },
				{ name: "packed", number: 2, type: 8, label: 1 },
				{ name: "jstype", number: 6, type: 14, label: 1, typeName: ".google.protobuf.FieldOptions.JSType", defaultValue: "JS_NORMAL" },
		...
		},
		{
			...
			field: [
				{ name: "deprecated", number: 33, type: 8, label: 1, defaultValue: "false" },
				{ name: "idempotency_level", number: 34, type: 14, label: 1, typeName: ".google.protobuf.MethodOptions.IdempotencyLevel", defaultValue: "IDEMPOTENCY_UNKNOWN" },
		...
		},
		{
			...
			field: [
				{ name: "defaults", number: 1, type: 11, label: 3, typeName: ".google.protobuf.FeatureSetDefaults.FeatureSetEditionDefault" },
			...
			nestedType: [
				{
					...
					field: [
						...
						{ name: "semantic", number: 5, type: 14, label: 1, typeName: ".google.protobuf.GeneratedCodeInfo.Annotation.Semantic" },
					],
					enumType: [
						{
							name: "Semantic",
	...
	for (const [jsonKey, jsonValue] of Object.entries(json)) {
		...
		if (field) {
			...
			if (
				jsonKey.startsWith("[") &&
				jsonKey.endsWith("]") &&
				(extension = (_a = opts.registry) === null || _a === undefined ? undefined : _a.getExtension(jsonKey.substring(1, jsonKey.length - 1))) &&
...
var file_capabilities_networking_http_v1alpha_trigger = /* @__PURE__ */ fileDesc(
...
function toByteArray(b64) {
	...
	for (i2 = 0; i2 < len2; i2 += 4)
		((tmp = (revLookup[b64.charCodeAt(i2)] << 18) | (revLookup[b64.charCodeAt(i2 + 1)] << 12) | (revLookup[b64.charCodeAt(i2 + 2)] << 6) | revLookup[b64.charCodeAt(i2 + 3)]),
			...
			(arr[curByte++] = tmp & 255));
	if (placeHoldersLen === 2) ((tmp = (revLookup[b64.charCodeAt(i2)] << 2) | (revLookup[b64.charCodeAt(i2 + 1)] >> 4)), (arr[curByte++] = tmp & 255));
...
function encodeChunk(uint8, start, end) {
	var tmp,
		output = [];
	for (var i2 = start; i2 < end; i2 += 3) ((tmp = ((uint8[i2] << 16) & 16711680) + ((uint8[i2 + 1] << 8) & 65280) + (uint8[i2 + 2] & 255)), output.push(tripletToBase64(tmp)));
	return output.join("");
}
function fromByteArray(uint8) {
	...
	else if (extraBytes === 2) ((tmp = (uint8[len2 - 2] << 8) + uint8[len2 - 1]), parts.push(lookup[tmp >> 10] + lookup[(tmp >> 4) & 63] + lookup[(tmp << 2) & 63] + "="));
	return parts.join("");
}
...
var ERR_OUT_OF_RANGE = E(
	...
	function (str, range, input) {
		...
		if (Number.isInteger(input) && Math.abs(input) > 4294967296) received = addNumericalSeparator(String(input));
			...
			if (((received = String(input)), input > BigInt(2) ** BigInt(32) || input < -(BigInt(2) ** BigInt(32)))) received = addNumericalSeparator(received);
			received += "n";
		}
...
function from(value, encodingOrOffset, length) {
	...
	if (typeof SharedArrayBuffer < "u" && (isInstance(value, SharedArrayBuffer) || (value && isInstance(value.buffer, SharedArrayBuffer)))) return fromArrayBuffer(value, encodingOrOffset, length);
	...
	if (b) return b;
	if (typeof Symbol < "u" && Symbol.toPrimitive != null && typeof value[Symbol.toPrimitive] === "function") return Buffer2.from(value[Symbol.toPrimitive]("string"), encodingOrOffset, length);
...
Buffer2.compare = function (a, b) {
	...
	if (!Buffer2.isBuffer(a) || !Buffer2.isBuffer(b)) throw TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
	if (a === b) return 0;
	let x = a.length,
		y = b.length;
...
Buffer2.prototype.compare = function (target, start, end, thisStart, thisEnd) {
	...
	if (!Buffer2.isBuffer(target)) throw TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type ' + typeof target);
	if (start === undefined) start = 0;
	if (end === undefined) end = target ? target.length : 0;
	if (thisStart === undefined) thisStart = 0;
	if (thisEnd === undefined) thisEnd = this.length;
	if (start < 0 || end > target.length || thisStart < 0 || thisEnd > this.length) throw RangeError("out of range index");
...
Buffer2.prototype.write = function (string, offset, length, encoding) {
	...
	if ((string.length > 0 && (length < 0 || offset < 0)) || offset > this.length) throw RangeError("Attempt to write outside buffer bounds");
	if (!encoding) encoding = "utf8";
	let loweredCase = false;
	for (;;)
		switch (encoding) {
...
function utf8Slice(buf, start, end) {
	...
	while (i2 < end) {
			...
			switch (bytesPerSequence) {
				...
				case 2:
					if (((secondByte = buf[i2 + 1]), (secondByte & 192) === 128)) {
						if (((tempCodePoint = ((firstByte & 31) << 6) | (secondByte & 63)), tempCodePoint > 127)) codePoint = tempCodePoint;
					}
					break;
				case 3:
		...
		else if (codePoint > 65535) ((codePoint -= 65536), res.push(((codePoint >>> 10) & 1023) | 55296), (codePoint = 56320 | (codePoint & 1023)));
...
Buffer2.prototype.readUintLE = Buffer2.prototype.readUIntLE = function (offset, byteLength2, noAssert) {
	if (((offset = offset >>> 0), (byteLength2 = byteLength2 >>> 0), !noAssert)) checkOffset(offset, byteLength2, this.length);
	let val = this[offset],
		mul = 1,
		i2 = 0;
...
Buffer2.prototype.writeInt32LE = function (value, offset, noAssert) {
	if (((value = +value), (offset = offset >>> 0), !noAssert)) checkInt(this, value, offset, 4, 2147483647, -2147483648);
...
function writeFloat(buf, value, offset, littleEndian, noAssert) {
	if (((value = +value), (offset = offset >>> 0), !noAssert)) checkIEEE754(buf, value, offset, 4, 340282346638528860000000000000000000000, -340282346638528860000000000000000000000);
...
Buffer2.prototype.fill = function (val, start, end, encoding) {
	if (typeof val === "string") {
		...
		if (typeof encoding === "string" && !Buffer2.isEncoding(encoding)) throw TypeError("Unknown encoding: " + encoding);
		if (val.length === 1) {
...
function checkBounds(buf, offset, byteLength2) {
	if ((validateNumber(offset, "offset"), buf[offset] === undefined || buf[offset + byteLength2] === undefined)) boundsError(offset, buf.length - (byteLength2 + 1));
}
...
function boundsError(value, length, type) {
	if (Math.floor(value) !== value) throw (validateNumber(value, type), new ERR_OUT_OF_RANGE(type || "offset", "an integer", value));
...
Url.prototype.parse = function (url, parseQueryString, slashesDenoteHost) {
	...
	if (((rest = rest.trim()), !slashesDenoteHost && url.split("#").length === 1)) {
		...
		if (simplePath) {
			if (((this.path = rest), (this.href = rest), (this.pathname = simplePath[1]), simplePath[2]))
				if (((this.search = simplePath[2]), parseQueryString)) this.query = querystring.parse(this.search.substr(1));
	...
	if (slashesDenoteHost || proto || rest.match(/^\/\/[^@\/]+@[^@\/]+/)) {
		...
		if (slashes && !(proto && hostlessProtocol[proto])) ((rest = rest.substr(2)), (this.slashes = true));
	}
	if (!hostlessProtocol[proto] && (slashes || (proto && !slashedProtocol[proto]))) {
		...
		if (((this.host = h + p), (this.href += this.host), ipv6Hostname)) {
			if (((this.hostname = this.hostname.substr(1, this.hostname.length - 2)), rest[0] !== "/")) rest = "/" + rest;
		}
	}
	...
	var qm = rest.indexOf("?");
	if (qm !== -1) {
		if (((this.search = rest.substr(qm)), (this.query = rest.substr(qm + 1)), parseQueryString)) this.query = querystring.parse(this.query);
...
Url.prototype.format = function () {
	...
	if (this.host) host = auth + this.host;
		...
		if (((host = auth + (this.hostname.indexOf(":") === -1 ? this.hostname : "[" + this.hostname + "]")), this.port)) host += ":" + this.port;
	}
	if (this.query && util_isObject(this.query) && Object.keys(this.query).length) query = querystring.stringify(this.query);
	var search = this.search || (query && "?" + query) || "";
	if (protocol && protocol.substr(-1) !== ":") protocol += ":";
	if (this.slashes || ((!protocol || slashedProtocol[protocol]) && host !== false)) {
		if (((host = "//" + (host || "")), pathname && pathname.charAt(0) !== "/")) pathname = "/" + pathname;
	} else if (!host) host = "";
...
Url.prototype.resolveObject = function (relative) {
	...
	if (isRelAbs)
		...
		if (psychotic) {
			...
			if (authInHost) ((result.auth = authInHost.shift()), (result.host = result.hostname = authInHost.shift()));
		}
	...
	var last = srcPath.slice(-1)[0],
		hasTrailingSlash = ((result.host || relative.host || srcPath.length > 1) && (last === "." || last === "..")) || last === "",
		up = 0;
	...
	if (((mustEndAbs = mustEndAbs || (result.host && srcPath.length)), mustEndAbs && !isAbsolute)) srcPath.unshift("");
	if (!srcPath.length) ((result.pathname = null), (result.path = null));
	else result.pathname = srcPath.join("/");
	if (!util_isNull(result.pathname) || !util_isNull(result.search)) result.path = (result.pathname ? result.pathname : "") + (result.search ? result.search : "");
...
var testnetByName = new Map([
	...
	["ethereum-testnet-sepolia-immutable-zkevm-1", ethereum_testnet_sepolia_immutable_zkevm_1_default],
	...
	["ethereum-testnet-sepolia-polygon-validium-1", ethereum_testnet_sepolia_polygon_validium_1_default],
...
class Int64 {
	...
	static toInt64Bigint(v) {
		...
		if (!Number.isFinite(v) || !Number.isInteger(v)) throw new Error("int64 requires an integer number");
		const bi = BigInt(v);
...
class UInt64 {
	...
	static toUint64Bigint(v) {
		...
		if (!Number.isFinite(v) || !Number.isInteger(v)) throw new Error("uint64 requires an integer number");
		const bi = BigInt(v);
...
class Decimal {
	...
	static parse(s) {
		...
		if (!m || (m[2] === "" && (m[3] === undefined || m[3] === ""))) throw new Error("invalid decimal string");
		const signStr = m[1] ?? "+";
		const intPart = m[2] ?? "0";
		let fracPart = m[3] ?? "";
...
class Value {
	...
	static wrapInternal(v) {
		...
		if (v instanceof Uint8Array) return create(ValueSchema2, { value: { case: "bytesValue", value: v } });
...
function addIssueToContext(ctx, issueData) {
	...
	const issue = makeIssue({
		...
		data: ctx.data,
		path: ctx.path,
		errorMaps: [ctx.common.contextualErrorMap, ctx.schemaErrorMap, overrideMap, overrideMap === en_default ? undefined : en_default].filter((x) => !!x),
	});
...
var globalHostBindingsSchema = exports_external.object({
	...
	sendResponse: exports_external
		.function()
		.args(exports_external.union([exports_external.instanceof(Uint8Array), exports_external.custom()]))
	...
	awaitCapabilities: exports_external
		.function()
		.args(exports_external.union([exports_external.instanceof(Uint8Array), exports_external.custom()]), exports_external.number())
		.returns(exports_external.union([exports_external.instanceof(Uint8Array), exports_external.custom()])),
...
var modifiers = new Set(["memory", "indexed", "storage", "calldata"]);
var eventModifiers = new Set(["indexed"]);
var functionModifiers = new Set(["calldata", "memory", "storage"]);
var version = "1.0.8";
...
function parseAbiParameter(param, options) {
	...
	if (match.name && isSolidityKeyword(match.name)) throw new SolidityProtectedKeywordError({ param, name: match.name });
...
function isSolidityKeyword(name) {
	return (
		name === "address" || name === "bool" || name === "function" || name === "string" || name === "tuple" || bytesRegex.test(name) || integerRegex.test(name) || protectedKeywordsRegex.test(name)
	);
}
...
function size(value2) {
	if (isHex(value2, { strict: false })) return Math.ceil((value2.length - 2) / 2);
...
class BaseError3 extends Error {
	constructor(shortMessage, args = {}) {
		const details = (() => {
			if (args.cause instanceof BaseError3) return args.cause.details;
			if (args.cause?.message) return args.cause.message;
			return args.details;
		})();
		const docsPath = (() => {
			if (args.cause instanceof BaseError3) return args.cause.docsPath || args.docsPath;
...
`),
			{
				metaMessages: [`Params: (${formatAbiParams(params, { includeName: true })})`, `Data:   ${data} (${size2} bytes)`],
...
class AbiEncodingArrayLengthMismatchError extends BaseError3 {
	constructor({ expectedLength, givenLength, type }) {
		super(
			[`ABI encoding array length mismatch for type ${type}.`, `Expected length: ${expectedLength}`, `Given length: ${givenLength}`].join(`
`),
...
class AbiEncodingLengthMismatchError extends BaseError3 {
	constructor({ expectedLength, givenLength }) {
		super(
			["ABI encoding params/values length mismatch.", `Expected length (params): ${expectedLength}`, `Given length (values): ${givenLength}`].join(`
`),
...
class IntegerOutOfRangeError extends BaseError3 {
	constructor({ max, min, signed, size: size2, value: value2 }) {
		super(`Number "${value2}" is not in safe ${size2 ? `${size2 * 8}-bit ${signed ? "signed" : "unsigned"} ` : ""}integer range ${max ? `(${min} to ${max})` : `(above ${min})`}`, {
...
function trim(hexOrBytes, { dir = "left" } = {}) {
	...
	for (let i2 = 0; i2 < data.length - 1; i2++) {
		if (data[dir === "left" ? i2 : data.length - i2 - 1].toString() === "0") sliceLength++;
		else break;
	}
...
function hexToBigInt(hex, opts = {}) {
	const { signed } = opts;
	if (opts.size) assertSize2(hex, { size: opts.size });
...
function toHex(value2, opts = {}) {
	if (typeof value2 === "number" || typeof value2 === "bigint") return numberToHex(value2, opts);
...
function toBytes(value2, opts = {}) {
	if (typeof value2 === "number" || typeof value2 === "bigint") return numberToBytes(value2, opts);
...
function bytesToBigInt(bytes, opts = {}) {
	if (typeof opts.size !== "undefined") assertSize2(bytes, { size: opts.size });
...
function encodeBool(value2) {
	if (typeof value2 !== "boolean") throw new BaseError3(`Invalid boolean value: "${value2}" (type: ${typeof value2}). Expected: \`true\` or \`false\`.`);
...
function decodeNumber(cursor, param) {
	...
	const value2 = cursor.readBytes(32);
	return [size2 > 48 ? bytesToBigInt(value2, { signed }) : bytesToNumber(value2, { signed }), 32];
}
...
var SETTLEMENT_REQUEST_SIG = keccak256(toHex("SettlementRequest(uint256,string,uint8,bool,uint256)"));
...
var fetchHyperliquidPrice = (sendRequester, symbol2) => {
	const isTradfi = symbol2.startsWith("xyz:");
	const body = isTradfi ? encodeJsonBody({ type: "allMids", dex: "xyz" }) : encodeJsonBody({ type: "allMids" });
	...
	const mid = prices[symbol2] || prices[`xyz:${symbol2}`];
	if (!mid) throw new Error(`No price for "${symbol2}" on Hyperliquid`);
	return { price: parseFloat(mid) };
};
var fetchUniswapQuote = (sendRequester, tokenAddress, isBuy, amount, apiKey, origin) => {
...
var getSolanaTokenDecimals = (sendRequester, mintAddress) => {
	const resp = sendRequester
		.sendRequest({
			method: "POST",
			url: SOLANA_RPC,
...
var fetchJupiterQuote = (sendRequester, mintAddress, isBuy, amount) => {
...
var fetchQuote = (sendRequester, assetId, origin, isBuy, amount, uniswapApiKey) => {
	switch (origin) {
		case ORIGIN.SOLANA:
...
var onSettlementRequest = (runtime2, log) => {
	...
	if (!network282) throw new Error(`Network not found: ${config.chainSelectorName}`);
	const evmClient = new cre.capabilities.EVMClient(network282.chainSelector.selector);
	const uniswapApiKey = runtime2.getSecret({ id: "UNISWAP_API_KEY" }).result().value;
	const tradeId = BigInt(bytesToHex(log.topics[1]));
	const [assetId, origin, isBuy, amount] = decodeAbiParameters(parseAbiParameters("string assetId, uint8 origin, bool isBuy, uint256 amount"), bytesToHex(log.data));
	runtime2.log(`SettlementRequest: trade=${tradeId} asset=${assetId} origin=${origin} isBuy=${isBuy} amount=${amount}`);
	...
	const quoteResult = httpClient
		...
		.result();
	runtime2.log(`Price: $${quoteResult.price} per token (${isBuy ? "BUY" : "SELL"})`);
	const priceScaled = BigInt(Math.round(quoteResult.price * 1000000000000000000));
	const reportPayload = encodeAbiParameters(parseAbiParameters("uint256, uint256"), [tradeId, priceScaled]);
	const report2 = runtime2.report(prepareReportRequest(reportPayload)).result();
	const writeResult = evmClient
		.writeReport(runtime2, {
	...
	runtime2.log(`Report written: ${txHash}`);
	return txHash;
};
